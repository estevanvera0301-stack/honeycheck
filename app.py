...
st.markdown("""
<div style="position:relative; width:100%; min-height:420px; overflow:hidden;
            margin:-1rem -1rem 0 -1rem; display:flex; align-items:center;">
    ...
    <div style="position:absolute; left:0; top:0; bottom:0; width:4px;
        background:linear-gradient(180deg, transparent, #E8A820, #C8820A, transparent);
        z-index:6;"></div>

    <!-- Abeja SVG ilustrada — derecha -->
    <div style="position:absolute; right:60px; top:50%; transform:translateY(-50%);
                width:340px; height:340px; opacity:0.20; pointer-events:none; z-index:5;">
        <svg viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg" fill="#C8820A"
    ...
    <div style="position:relative; z-index:10; padding:52px 56px; width:100%; max-width:680px;">
        <div style="font-family:'DM Mono',monospace; font-size:10px; letter-spacing:4px;
                    color:#C8820A; text-transform:uppercase; margin-bottom:18px; opacity:0.9;">
            Calorimetría diferencial de barrido · Machine Learning
        </div>
        <div style="font-family:'Playfair Display',serif; font-size:clamp(52px,6vw,84px);
                    font-weight:900; line-height:0.90; color:#3D2200; letter-spacing:-1.5px; margin:0 0 6px 0;">
            Honey<span style="color:#C8820A; font-style:italic;">Check</span>
        </div>
        <div style="width:72px; height:2px; margin:22px 0;
                    background:linear-gradient(90deg,#E8A820,#F5D47A,transparent); border-radius:1px;"></div>
        <p style="font-family:'Cormorant Garamond',serif; font-size:19px; font-weight:500;
                  color:#5C3A0A; margin:0 0 30px 0; max-width:500px; line-height:1.55;">
            Detección de adulteración y trazabilidad geográfica de mieles colombianas mediante análisis DSC
            y modelos de clasificación supervisada.
        </p>
        <div style="display:flex; gap:12px; flex-wrap:wrap; align-items:center;">
            <span style="font-family:'DM Mono',monospace; font-size:10px; letter-spacing:2px;
                         color:#5C3D00; border:1px solid #E8A820; padding:7px 16px; border-radius:2px;
                         background:rgba(255,255,255,0.65); backdrop-filter:blur(8px); text-transform:uppercase;">
